    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center  text-info text-uppercase">@lang('common.Edit') @lang('common.Role')</h4>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">                        
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <!-- description -->
                                <div class="item form-group">
                                    <input value="{{ $model->description }}" type="text" id="description" name="description" class="form-control"
                                    />
                                    <span class="help-block">
                        ...
                        <!-- /.row -->
                        @php                            
                            $role_permissions = $model->permissions->map(function ($item, $key) {
                                return $item->id;
                            });
                        @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-6  text-left">
                                ...
                                <ul class="to_do">
                                    ...
                                    <p>
                                        <label><input type="checkbox" name="permissions" value="{{ $permission->id }}" {{ in_array($permission->id, $role_permissions->all()) ? 'checked' : '' }}> {{ _sentence_case($permission->name,'ucwords') }}</label>
                                    </p>
